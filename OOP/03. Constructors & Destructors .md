...
``` 
1. If no constructor defined → Compiler provides a default constructor

2. If ANY constructor defined → Compiler does NOT provide a default

3. Copy constructor is called when:
   • Object initialized from another object
   • Object passed by value to the function
...
``` 
Default         → When default values are acceptable
Parameterized   → When custom initialization is needed
Copy            → When deep copy is required
Move            → When dealing with dynamic resources
```
