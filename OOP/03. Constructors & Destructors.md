...
> A complete reference covering every constructor type, copy/move semantics, initializer lists, the Rule of Zero/Three/Five, and destructor behavior — including virtual and pure virtual destructors.

---

## 📑 Table of Contents

**1. [Quick Reference: Constructor Types](#1-quick-reference-constructor-types)**
&nbsp;&nbsp;1.1 [Types of Constructors](#11-types-of-constructors) · 1.2 [Default Constructor](#12-default-constructor) · 1.3 [Parameterized Constructor](#13-parameterized-constructor) · 1.4 [Copy Constructor](#14-copy-constructor) · 1.5 [Move Constructor (C++11)](#15-move-constructor-c11) · 1.6 [Quick Reference Summary](#16-quick-reference-summary)

**2. [Copy Constructor — Deep Dive](#2-copy-constructor--deep-dive)**
&nbsp;&nbsp;2.1 [What is a Copy Constructor?](#21-what-is-a-copy-constructor) · 2.2 [When is it Called?](#22-when-is-the-copy-constructor-called) · 2.3 [Shallow Copy](#23-shallow-copy) · 2.4 [Deep Copy](#24-deep-copy) · 2.5 [Complete Comparison Example](#25-complete-comparison-example) · 2.6 [Visual Representation](#26-visual-representation)

**3. [Rule of Zero / Three / Five](#3-rule-of-zero--three--five)**
&nbsp;&nbsp;3.1 [Constructor Categories & Semantics](#31-constructor-categories--semantics) · 3.2 [Rule of Zero/Three/Five](#32-rule-of-zerothreefive)

**4. [Move Semantics & Move Constructor](#4-move-semantics--move-constructor)**
&nbsp;&nbsp;4.1 [Lvalue vs Rvalue](#41-lvalue-vs-rvalue) · 4.2 [Lvalue vs Rvalue References](#42-lvalue-references-vs-rvalue-references) · 4.3 [Why Move Semantics?](#43-why-move-semantics) · 4.4 [Move Constructor](#44-move-constructor) · 4.5 [Move Assignment Operator](#45-move-assignment-operator) · 4.6 [std::move Explained](#46-stdmove-explained) · 4.7 [Complete Implementation Example](#47-complete-implementation-example) · 4.8 [Perfect Forwarding](#48-perfect-forwarding) · 4.9 [Performance Comparison](#49-performance-comparison) · 4.10 [Best Practices & Pitfalls](#410-best-practices--pitfalls) · 4.11 [Quick Reference Card](#411-quick-reference-card)

**5. [Initializer Lists — Deep Dive](#5-initializer-lists--deep-dive)**
&nbsp;&nbsp;5.1 [What is an Initializer List?](#51-what-is-an-initializer-list) · 5.2 [Syntax Variations](#52-syntax-variations) · 5.3 [Init List vs Constructor Body](#53-initializer-list-vs-constructor-body) · 5.4 [Performance Benefits](#54-performance-benefits) · 5.5 [Mandatory Use Cases](#55-mandatory-use-cases) · 5.6 [Initialization Order](#56-initialization-order) · 5.7 [Modern C++ Features](#57-modern-c-features-c11141720) · 5.8 [Best Practices](#58-best-practices)

**6. [Destructors — Deep Dive](#6-destructors--deep-dive)**
&nbsp;&nbsp;6.1 [What is a Destructor?](#61-what-is-a-destructor) · 6.2 [Basic Destructor](#62-basic-destructor) · 6.3 [When is it Called?](#63-when-is-destructor-called) · 6.4 [Behavior with Inheritance](#64-destructor-behavior-with-inheritance) · 6.5 [Problem: Non-Virtual Destructors](#65-the-problem-non-virtual-destructors) · 6.6 [Virtual Destructors](#66-virtual-destructors) · 6.7 [Pure Virtual Destructors](#67-pure-virtual-destructors) · 6.8 [Modern C++ Destructor Features](#68-modern-c-destructor-features) · 6.9 [Best Practices & Pitfalls](#69-best-practices--common-pitfalls)

---

## 1. Quick Reference: Constructor Types
...
### 2.2 When is the copy constructor called?
...
### 2.5 Complete Comparison Example
...
### 3.1 Constructor Categories & Semantics
...
### 3.2 Rule of Zero/Three/Five

**a: Rule of Zero (Preferred):**  
...
│  • Can appear on LEFT side of the assignment                    │
│  • Has a name/identity                                          │
...
│  • Exists only within an expression                             │
...
```
### 4.2 Lvalue References vs Rvalue References
...
### 4.7 Complete Implementation Example
...
### 5.3 Initializer List vs Constructor Body
**Comparison:**
...
### 5.7 Modern C++ Features (C++11/14/17/20)
...
=== Main ends ===
  [-] Static in the function destroyed
  [-] Global destroyed
...
### 6.4 Destructor Behavior with Inheritance
...
### 6.5 The Problem: Non-Virtual Destructors
**The Classic Problem:**
...
```
### 6.8 Modern C++ Destructor Features
...
### 6.9 Best Practices & Common Pitfalls
Best Practices
``` cpp
#include <iostream>
#include <memory>
